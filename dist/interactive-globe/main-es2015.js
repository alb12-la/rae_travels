...
let GlobeViewComponent = class GlobeViewComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            // mousewheel listener
            this.earthContainer.nativeElement.addEventListener('mousewheel', (event) => this.updateCoordinates(event));
            // touch device listener
            this.earthContainer.nativeElement.addEventListener('touchend', (event) => this.updateCoordinates(event));
            // click listener
            this.earthContainer.nativeElement.addEventListener('click', (event) => this.updateCoordinates(event));
        });
    }
    ngOnChanges(changes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
