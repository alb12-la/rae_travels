...
export class AppComponent implements OnInit {
  ...
  loc1: Marker = new Marker(
    ...
    [
      new Content(ContentType.IMAGE, '../assets/images/cattle-point-lighthouse-2.jpg'),
      new Content(ContentType.IMAGE, '../assets/images/cattle-point-lighthouse.jpg'),
      new Content(ContentType.IMAGE, '../assets/images/cattle-point-lighthouse-3.jpg'),
    ],
  ...
  loc2: Marker = new Marker(
    ...
    '../assets/markers/san-diego-marker.png',
    [
      new Content(ContentType.IMAGE, '../assets/images/san-diego-featured.jpg'),
      new Content(ContentType.IMAGE, '../assets/images/san-diego-3.jpg', 'The beautiful scenery here makes time stand still.'),
      new Content(ContentType.IMAGE, '../assets/images/san-diego-1.jpg'),
      new Content(ContentType.IMAGE, '../assets/images/san-diego-2.jpg', 'Beautiful flamingos.'),
      new Content(ContentType.IMAGE, '../assets/images/san-diego-4.jpg', 'Giant Tortoise older than my parents.'),
    ],
  ...
  loc5 = new Marker(
    ...
    'Las Vegas, Nevada',
    '../assets/markers/vegas-marker.png',
    [
      new Content(ContentType.IMAGE, '../assets/images/las-vegas-2.jpg', 'Tryna stay out of the scorching sun. '),
      new Content(ContentType.IMAGE, '../assets/images/hoover-dam-1.jpg', 'What a neat dam.'),
      new Content(ContentType.IMAGE, '../assets/images/hoover-dam-2.jpg', 'Mingling with some desert locals on route 66'),
    ],
